...
class SBServiceTenantPaid extends StatefulWidget {
  ...
  @override
  State<SBServiceTenantPaid> createState() => _SBServiceTenantPaidState();
}

class _SBServiceTenantPaidState extends State<SBServiceTenantPaid> {
  @override
    ...
    void _UpdateStatus(String documentMonthRoom, bool newStatus) {
      ...
      showDialog(
          ...
          builder: (context) => AlertDialog(
                ...
                content:
                    const Text("Bạn có chắc chắn căn hộ này chưa dóng tiền?")
                        .tr(),
                actions: [
                  // CANCEL BUTTON
                  TextButton(
